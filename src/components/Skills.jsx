        ...
        <section ref={ref} id='skills' className='skills'>
          <div className={inView ? 'is-in-viewport' : 'is-out-of-viewport'}>
            <div className='wrapper'>
              <Content
                title='Skills'
                description='Berufserfahrung in der Webentwicklung mit HTML, Css, Sass(Dart Sass), Native Javascript, PHP-basierten CMS, React und Entwicklung von Styleguid und Storybook durch agile Methoden.
